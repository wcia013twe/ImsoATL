                    ...
                    fetch('/data/cities/atlanta.json').then({
                        ...
                        "InteractiveMap.useEffect": (error)=>{
                            ...
                            if (map.current) {
                                ...
                                map.current.addLayer(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mapbox$2d$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAP_LAYERS"].atlantaBoundary);
                            }
                        }
                    }["InteractiveMap.useEffect"]);
...
_s(InteractiveMap, "IFsYgFY+8aO3ARdWq5v5r8QvanE=");
_c = InteractiveMap;
var _c;
